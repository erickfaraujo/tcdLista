...
public class ListaController {
	...
	public Collection<Lista> getListas(@PathVariable("userId") int userId) {
	...
	public Collection<Lista> getListaByTipo(@PathVariable("userId") int userId, @PathVariable("tipoLista") int tipoLista) {
